    ...
    <>
      <div className="h-[100vh] w-full">
        <div className="flex justify-end items-center p-2 px-3 ">
          <div>
            <Link to="/" className="px-3 py-2  w-full hover:bg-blue-300 rounded-full text-base bg-[#148ccd] text-white flex items-center gap-2 font-medium" > <FiUser/> Sign in </Link>
          </div>
        </div>
            ...
            <div className=' search-box lg:w-[832px] flex flex-col justify-center gap-2'>
              ...
              <div className='flex flex-col gap-4'>
                <div className='flex items-center gap-1 mt-3'>
                  ...
                  <button className='bg-[#148ccd] px-6 font-medium  rounded-full  text-white h-[50px]' >Search</button>
                </div>
                <div className='flex flex-wrap justify-center  items-center gap-3'>
                  <button className='rounded-full px-[12px] py-[9px] whitespace-nowrap border border-[#e0e4e9] text-sm text-[#464e56] hover:border-[#148ccd] hover:text-[#148ccd] hover:bg-[#148ccd20] font-bold flex gap-1 items-center'> <TbBasketSearch className='text-base'/> All</button>
